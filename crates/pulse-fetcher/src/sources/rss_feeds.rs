...
const FEEDS: &[(&str, &str, &str, &str)] = &[
    ...
    ("freedom_financial", "Mr Money Mustache", "https://www.mrmoneymustache.com/feed/", "en"),
    ("freedom_financial", "Financial Samurai", "https://www.financialsamurai.com/feed/", "en"),
    ("freedom_financial", "Of Dollars And Data", "https://ofdollarsanddata.com/feed/", "en"),
    ("freedom_financial", "Motley Fool", "https://www.fool.com/feeds/index.aspx", "en"),
    ("freedom_financial", "Seeking Alpha", "https://seekingalpha.com/feed.xml", "en"),
    ("freedom_financial", "Investopedia", "https://www.investopedia.com/feedbuilder/feed/getfeed?feedName=rss_headline", "en"),
    ("freedom_financial", "Bankrate", "https://www.bankrate.com/feed/", "en"),
    ("freedom_financial", "Stratechery", "https://stratechery.com/feed/", "en"),
    ("freedom_financial", "SaaStr Blog", "https://www.saastr.com/feed/", "en"),
    ("freedom_financial", "Bootstrapped Founder", "https://thebootstrappedfounder.com/feed/", "en"),
    ("freedom_financial", "Kiplinger", "https://www.kiplinger.com/feed/all", "en"),
    ("freedom_financial", "NerdWallet Blog", "https://www.nerdwallet.com/blog/feed/", "en"),
    ("freedom_financial", "The Hustle", "https://thehustle.co/feed/", "en"),
    ("freedom_financial", "Morning Brew", "https://www.morningbrew.com/daily/rss", "en"),
    ("freedom_financial", "Abnormal Returns", "https://abnormalreturns.com/feed/", "en"),
    ("freedom_financial", "A Wealth of Common Sense", "https://awealthofcommonsense.com/feed/", "en"),
    ("freedom_financial", "The Irrelevant Investor", "https://theirrelevantinvestor.com/feed/", "en"),
    ("freedom_financial", "Marker (Medium)", "https://marker.medium.com/feed", "en"),
    ("freedom_financial", "Collaborative Fund Blog", "https://www.collaborativefund.com/feed.xml", "en"),
    ("freedom_financial", "Finimize", "https://www.finimize.com/wp/feed/", "en"),
