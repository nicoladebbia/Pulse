...
const FEEDS: &[(&str, &str, &str)] = &[
    ...
    ("freedom_financial", "Freedom: Investing", "https://news.google.com/rss/search?q=investing+strategy+OR+%22stock+market%22+today+OR+crypto+news+OR+%22real+estate+investing%22+OR+%22FIRE+movement%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Business", "https://news.google.com/rss/search?q=bootstrapping+OR+%22SaaS+revenue%22+OR+%22startup+funding%22+OR+%22dividend+income%22+OR+%22personal+finance%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Passive Income", "https://news.google.com/rss/search?q=%22passive+income%22+OR+%22income+streams%22+OR+%22rental+income%22+OR+%22royalty+income%22+OR+%22affiliate+marketing%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Crypto DeFi", "https://news.google.com/rss/search?q=%22crypto+investing%22+OR+%22DeFi+yield%22+OR+%22Bitcoin+strategy%22+OR+%22Ethereum+staking%22+OR+%22crypto+portfolio%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Real Estate", "https://news.google.com/rss/search?q=%22real+estate+investing%22+OR+%22rental+property%22+OR+%22Airbnb+host%22+OR+%22house+hacking%22+OR+REIT+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Tax Strategy", "https://news.google.com/rss/search?q=%22tax+strategy%22+OR+%22tax+optimization%22+OR+%22tax+free%22+OR+%22LLC+taxes%22+OR+%22capital+gains+tax%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Indie SaaS", "https://news.google.com/rss/search?q=%22indie+hacker%22+OR+%22micro+SaaS%22+OR+%22bootstrapped+startup%22+OR+%22MRR+milestone%22+OR+%22solo+SaaS%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Wealth Building", "https://news.google.com/rss/search?q=%22wealth+building%22+OR+%22net+worth%22+OR+%22compound+interest%22+OR+%22index+fund%22+OR+%22financial+freedom%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Side Hustles", "https://news.google.com/rss/search?q=%22side+hustle%22+OR+%22freelance+income%22+OR+%22gig+economy%22+OR+%22monetize+skills%22+OR+%22online+business%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Market Analysis", "https://news.google.com/rss/search?q=%22market+analysis%22+OR+%22S%26P+500%22+OR+%22market+crash%22+OR+%22bull+market%22+OR+%22recession+risk%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Fintech", "https://news.google.com/rss/search?q=fintech+OR+neobank+OR+%22digital+banking%22+OR+Robinhood+OR+%22payment+platform%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
    ("freedom_financial", "Freedom: Venture Capital", "https://news.google.com/rss/search?q=%22venture+capital%22+OR+%22angel+investing%22+OR+%22seed+round%22+OR+%22Series+A%22+OR+%22startup+valuation%22+when:1d&hl=en-US&gl=US&ceid=US:en"),
